...
class Extension extends patch_js_1.Patch {
     ...
     */
    static get applied() {
        return patch_js_1.Patch.applied;
    }
    /**
    ...
    static scopedTo(owner) {
        return patch_js_1.Patch.scopedTo(owner);
    }
    /**
 ...
 */
Extension.ExtensionSet = class ExtensionSet {
    /**
